...
3. Соберите образы и запустите сервисы:
   ...
   **Безопасность:** для `backend` в Compose добавлены базовые runtime-ограничения: файловая система только для чтения, временный каталог в `tmpfs`, запрет на повышение привилегий, удаление лишних capabilities и ограничение числа процессов.
